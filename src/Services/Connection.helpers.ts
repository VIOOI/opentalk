...
import { DefaultPostAds, DefaultSmallAds } from "../Schemas/Ads.js";
...
export const connectMessage = (
  ...
  yield* safeSendMessage(context, self.chat, yield* queue.print(that), { reply_markup: StopConventionKeyboard })
}).pipe(
  Effect.catchTags({
